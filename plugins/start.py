...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        # Set a random reaction emoji on the /start message
        try:
            ...
            # Fallback to a default reaction if the selected emoji is not supported
            try:
                await client.set_message_reaction(
                    chat_id=message.chat.id,
                    message_id=message.id,
                ...
                print(f"Failed to set fallback reaction: {e}")
        ...
        try:
            ...
            print(f"Failed to delete sticker message: {e}")
