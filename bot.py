    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL1:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Contact WhoAmI or MehediYT for support")
                sys.exit()
        ...
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated by WhoAmI and MehediYT")
...
| (_| (_) | |) | _|| _|| |__ | | >  <| _ \ (_) || | \__ \
 \___\___/|___/|___|_| |____|___/_/\_\___/\___/ |_| |___/
        ...
        self.LOGGER(__name__).info(f"Bot Running..! Made by WhoAmI and MehediYT")   
        ...
        try: await self.send_message(OWNER_ID, text = f"<b><blockquote>- ʙᴏᴛ ʀᴇsᴛᴀʀᴛᴇᴅ ʙʏ ᴡʜᴏᴀᴍɪ ᴀɴᴅ ᴍᴇʜᴇᴅɪʏᴛ</blockquote></b>")
        except: pass
    ...
    def run(self):
        ...
        self.LOGGER(__name__).info("Bot is now running. Thanks to WhoAmI and MehediYT")
        try:
            loop.run_forever()
